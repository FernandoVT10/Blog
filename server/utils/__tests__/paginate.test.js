...
describe("Paginate", () => {
    it("It should get 7 pages with the 'hasPrevPage' and 'hasNextPage' active", () => {
        const pagination = paginate(100, 72);

        expect(pagination).toMatchSnapshot();
    });

    it("It should get the 'hasPrevPage' and 'hasNextPage' desactive", () => {
    ...
    it("It should get the 'hasPrevPage' active", () => {
    ...
    it("It should get the 'hasNextPage' active", () => {
